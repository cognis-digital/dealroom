"""Native cognis-connect emit for dealroom — forward findings to any platform.

Maps dealroom's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    dealroom ... --format json | dealroom-emit --to stix
    dealroom-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
